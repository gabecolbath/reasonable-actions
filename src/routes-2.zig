...
pub const map = .{
    ...
    .post = RouteMap.initComptime(.{
        ...
        .{ "/scatty/room/connect/:client_urn", upgradeToWebsocket },
    }),
};
...
pub fn createRoomFromForm(app: *App, req: *Request, res: *Response) !void {
    const template = 
        ...
        \\      ws-connect="/scatty/room/connect/{{client_urn}}">
...
pub fn upgradeToWebsocket(app: *App, req: *Request, res: *Response) !void {
    ...
    const is_successfully_connected = try httpz.upgradeWebsocket(server.Connection, req, res, &.{
        .app = app,
